-- Enable realtime for production-ready messaging system
-- Based on Supabase official documentation and best practices

-- Enable realtime on critical messaging tables
...
-- Create trigger to auto-update message timestamps
...
DROP TRIGGER IF EXISTS message_update_timestamp ON messages;
